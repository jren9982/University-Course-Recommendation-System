        ...
        <div class="table-title">
            <div class="row">
                ...
                <form class="d-flex" action="admin_search.php" method="post">
                    <input class="form-control mr-sm-2" type="text" name="search" value="<?php if(isset($_POST['search'])){echo $_POST['search'];} ?>" id="search" class="form-control"
                           size="23" placeholder="Search Course..." required>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="admin_update.php" method="post">
                ...
                <div class="modal-footer">
                    <!-- placeholder to store values to send to admin_update on submission of form -->
                    <input type="hidden" name="updateCourse" value="0">
                    <input id="course_name" name="course_name" value="" type="hidden">
                    <!-- end of placeholders -->
                    <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $(document).on('click', '.edit', function(){
            ...
            $('#e90pct').val(data[4]);
            $course_name = data[2];
            document.getElementById("course_name").setAttribute('value',$course_name);
        });
    });
</script>
